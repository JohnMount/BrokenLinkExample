...
Observed: this link [https://github.com/JohnMount/BrokenLinkExample/blob/master/extras/Untitled.md](https://github.com/JohnMount/BrokenLinkExample/blob/master/extras/Untitled.md) works in [README.md](https://github.com/JohnMount/BrokenLinkExample/blob/master/README.md) but is broken in [docs/index.html](https://johnmount.github.io/BrokenLinkExample/).
